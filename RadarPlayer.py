...
df1 = pd.read_excel('LigaColombia22_FullSeasonT_AllMetricsCalculated_DataCleaning.xlsx')
df2 = pd.read_excel('LigaArgentina22_FullSeason_AllMetricsCalculated_DataCleaning.xlsx')
df3 = pd.read_excel('LigaBolivia22_FullSeason_AllMetricsCalculated_DataCleaning.xlsx')
df4 = pd.read_excel('LigaChile22_FullSeason_AllMetricsCalculated_DataCleaning.xlsx')
df5 = pd.read_excel('LigaEcuador22_FullSeason_AllMetricsCalculated_DataCleaning.xlsx')
df6 = pd.read_excel('LigaParaguay22_FullSeason_AllMetricsCalculated_DataCleaning.xlsx')
df7 = pd.read_excel('LigaPerú22_FullSeason_AllMetricsCalculated_DataCleaning.xlsx')
